...
k <- area_indexer(parameters="nitrate", doParameters=T, areanames="P5", years=c(2010, 2020))
head(k)
```
...
```{r, message=FALSE, error=FALSE, warning=FALSE, fig.cap="Figure 3: Sampling freqency per month for nitrate at station P5"}
