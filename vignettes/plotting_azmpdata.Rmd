...
# add 'year', 'month', and 'day' to df_data
df_data <- data.frame(df_data,
                      year = as.POSIXlt(df_data[['date']], tz = 'UTC')$year + 1900,
                      month = as.POSIXlt(df_data[['date']], tz = 'UTC')$mon + 1,
                      day = as.POSIXlt(df_data[['date']], tz = 'UTC')$mday)
