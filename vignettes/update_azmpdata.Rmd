...
Biological data is loaded into the package using individual scripts for each dataframe. These scripts are contained in `inst/extdata` and organized by folder depending on the data type. These scripts output package data objects but __note that after running these scripts the package data will only contain biological data and must be completed with the physical data by completeing the next steps__. 
